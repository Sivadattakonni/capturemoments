...
load_dotenv()  # Make sure this runs before accessing the key
...
app.config['MAIL_USERNAME'] = 'sivadattakonni@gmail.com'       # Replace with your email
app.config['MAIL_PASSWORD'] = 'dbzq hqty aztf krur'            # Replace with app password

mail = Mail(app)

# Step 3: Dummy data for photographers (simulating database)
photographers = [
    {"id": "p1", "name": "hanuma", "skills": ["Wedding", "Portrait"], "image": "hanuma.jpg","location":"Hyderabad"},
    {"id": "p2", "name": "ram", "skills": ["Fashion", "Event"], "image": "ram.jpg","location":"Mumbai"},
    {"id": "p3", "name": "sita", "skills": ["All Events", "Event"], "image": "sita.jpg","location":"Benguluru"}
]
...
"""
        ...
        try:
            ...
            flash('Booking confirmed, but email could not be sent. Please check your network or email settings.', 'warning')
